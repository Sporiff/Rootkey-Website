...
# Rootkey build configuration file, created by
# `ablog start` on Wed May  8 19:16:30 2019.
#
...
blog_authors = {
    'Sporiff': ('Ciarán Ainsworth', 'https://bakusocial.com/@Sporiff'),
}
...
# Default is ``{}``.
blog_locations = {
    'Exeter': ('Exeter, United Kingdom', 'https://en.wikipedia.org/wiki/Exeter'),
}
...
blog_default_author = 'Sporiff'

# Set blog default language

blog_default_language = 'en'

# Set blog default location

blog_default_location = 'Exeter'
...
fontawesome_link_cdn = 'https://use.fontawesome.com/releases/v5.8.2/css/all.css'
...
project = u'Rootkey'
copyright = u'2019, Ciarán Ainsworth'
author = u'Sporiff'
...
# documentation.
html_theme_options = {
    'donate_url' = 'https://liberapay.com/ciaranainsworth',
}
...
html_title = 'Life Inside a Computer'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rootkey'
